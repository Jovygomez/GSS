...
We reject the null hypothesis because the P value is lower than .05. The fisher exact test shows that the odds of 2.27 would round up to 2.3:1 due to the p-value being lowerb than 0.05.
...
The tables show that the Junior College and Bachelor are appromitaley the same. The Graduate indicates that it is much higher, and LT Highschool and High school is much lower. 
...
There is no statistical evidence between the difference wordsum performance of LT Highschool than Highschool
